...
use vulkano::swapchain::{AcquireError, Swapchain, SwapchainCreationError, SurfaceTransform, PresentMode, ColorSpace, FullscreenExclusive};
use vulkano::sync;
...
mod vulkan_CV;
mod mqtt;
use mqtt::mq_server::create_server;
...
fn test_vulkan() {
    // 创建实例，然后获取物理设备，进而获取设备与队列用来进行操作。
    // let instance = Instance::new(None, Version::V1_1, &InstanceExtensions::none(), None)
    // .expect("failed to create instance");
    let instance = {
        let extensions = vulkano_win::required_extensions();
        Instance::new(None, Version::V1_1, &extensions, None).expect("failed to create Vulkan instance")
    };
    ...
    let (image_num, suboptimal, acquire_future) = swapchain::acquire_next_image(swapchain.clone(), None).unwrap();
...
fn triangle() {
    ...
    let vertex_buffer = CpuAccessibleBuffer::from_iter(
        ...
        //     },
        //     Vertex {
        //         position: [-0.501, -0.201],
        //     },
        //     Vertex {
        //         position: [-0.501, -0.202],
        //     },
        ...
        //     },
        //     Vertex {
        //         position: [-0.502, -0.201],
        //     },
        //     Vertex {
        //         position: [-0.502, -0.202],
        //     },
        //     // Vertex {
        //     //     position: [0.0, 0.5],
        //     // },
    ...
    event_loop.run(move |event, _, control_flow| {
        match event {
            ...
            Event::RedrawEventsCleared => {
                ...
                // 颜色设置，设置背景色
                let clear_values = vec![[0.0, 0.0, 0.0, 0.6].into()];
